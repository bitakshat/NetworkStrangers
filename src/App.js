    ...
    <div className="App font-display">
      ...
      <section className="w-full text-[#6C6C6C]">
        <div className="mt-10 flex justify-center items-center flex-col">
          <h3 className="text-primary font-w400 text-[#000]" data-aos="fade-up">
      ...
      <section className="w-full bg-black text-zinc-50 mt-40 p-20 pb-40">
        <div className="w-[1062px]">
          ...
          <div className="flex flex-col gap-3 mt-5 text-[#CECECE]" data-aos="fade-up">
      ...
      <section className="w-full flex justify-center items-center flex-col gap-10 p-10">
        <h4 className="text-f24 text-[#1E1E1E]" data-aos="fade-up">
        ...
        {/* line */}
        <div className="h-[3px] w-3/4 bg-gradient-to-r from-white from-1% via-sky-500 via-[percentage:80%] to-white" data-aos="fade-up"></div>

        {/* banner  */}
        <div className="w-[1510px] mt-20 mb-20 relative flex justify-center items-center text-white">
